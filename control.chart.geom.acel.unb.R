...
dados  <- c(rgeom(n=10, prob = p0), rgeom(n=40, prob = p))
obj <- qcc(dados[1:10],type="g", sizes = 1, center = 1/p0, newdata = dados[11:50], newsizes = 1, ylab="Number of conformities", xlab="Sample number", title="ARL-unbiased g-chart")
